...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($update) {
    header("Location: detailresep.php?id=$id_resep");
    exit;
  } else {
...
<div class="sidebar">
  ...
  <ul class="navigasi">
    <li><a href="../beranda.php">Pencarian</a></li>
...
<div class="konten">
  ...
  <form method="post" action="hapusresep.php" onsubmit="return confirm('Yakin ingin menghapus resep ini?')">
